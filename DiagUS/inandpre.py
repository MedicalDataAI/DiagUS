...
if __name__ == "__main__":
    ...
    model_path = r"model\inandpre\SVM.pkl"
    # 总 Label 表的路径
    label_path = r"data\label.csv"
    
    output_directory = r"result\inandpre"
    
    datasets_to_process = {
        # 你的数据集路径
        "train": r"data\inandpre\train_selected_features_lasso.csv",
        "test": r"data\inandpre\train_selected_features_lasso.csv",
