...
if __name__ == "__main__":
    ...
    model_path = r"project\tj_fck\wangwenwen\yanqing\git\model\pre\SVM.pkl"
    # 总 Label 表的路径
    label_path = r"project\tj_fck\wangwenwen\yanqing\git\data\label.csv"
    
    output_directory = r"project\tj_fck\wangwenwen\yanqing\git\result\pre"
    
    datasets_to_process = {
        # 你的数据集路径
        "train": r"project\tj_fck\wangwenwen\yanqing\git\data\pre\train_selected_features_lasso.csv",
        "test": r"project\tj_fck\wangwenwen\yanqing\git\data\pre\train_selected_features_lasso.csv",
